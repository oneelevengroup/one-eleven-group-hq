        ...
        <div>
          ...
          {calLoading ? (
            ...
            <div className="flex flex-col gap-1.5">
              <p className="text-xs text-muted-foreground">Connect your Google Calendar to see your schedule here.</p>
              <Button size="sm" variant="outline" onClick={handleConnect} className="w-fit text-xs">
