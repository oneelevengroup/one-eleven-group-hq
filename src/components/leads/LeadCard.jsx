...
export default function LeadCard({ lead, owner }) {
  return (
    <Link to={`/leads/${lead.id}`} className="block bg-card rounded-lg p-3 border border-border hover:border-accent/50 transition-colors">
